...
const steps = [
  {
    icon: Plug,
    title: "Свързване",
    text: "Интегрираме се със съществуващите ви IP камери през RTSP/ONVIF. Без подмяна на камери. Настройка за под 24 часа.",
  },
  {
    icon: ScanEye,
    title: "Детекция",
    text: "AI анализира живия поток 24/7. Drive-off, проникване и движение в зони с ограничен достъп — маркирани за милисекунди.",
  },
  {
    icon: Bell,
    title: "Реакция",
